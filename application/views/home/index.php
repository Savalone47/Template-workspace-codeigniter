      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h4 data-aos="fade-up">Apropos De Nous</h4>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
					<?php foreach($parts as $pat): ?>
						 <div class="swiper-slide"><a href="<?php echo base_url('partenaire/detail/'.$pat['patid'])?>"><img src="<?php echo base_url($pat['image'])?>" class="img-fluid" alt=""></a></div>
          <?php endforeach; ?>
					</div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up">
            <div class="icon-box">
              <div class="icon"><i class="<?php echo $serv['icon']?>"></i></div>
              <h4 class="title"><a href=""><?php echo $serv['title']?></a></h4>
              <p class="description"><?php echo $serv['desc']?></p>
            </div>
          </div>
		  <?php endforeach;?>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Salle</li>
              <li data-filter=".filter-card">Bureau</li>
              <li data-filter=".filter-web">personnel</li>
            </ul>
          </div>
        </div>
