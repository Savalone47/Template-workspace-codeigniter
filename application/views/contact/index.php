                  ...
                  <tbody>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $ct['subjet']?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $ct['name']?></p>
                      </td>
					  					<td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $ct['email']?></p>
                      </td>
					  					<td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $ct['message']?></p>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $ct['created_at']?></span>
                      </td>
                      <td class="align-middle">
                        <!-- <a href="<?php echo base_url('contact/edit/'. $ct['contactID']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
															<button class="btn btn-primary btn-sm ms-auto">Edit</button>
                        </a> -->
													<a href="<?php echo base_url('contact/remove/'. $ct['contactID']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delete user">
